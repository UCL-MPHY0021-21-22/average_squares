...
if __name__ == "__main__":
    parser = ArgumentParser(description="Generate average") #comes in the help bit
    parser.add_argument('numbers', nargs="+",type=float,help="The numbers to make an average from")
